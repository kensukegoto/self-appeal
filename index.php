    ...
    <section class="b-profile" id="profile">
      ...
      <div class="b-profile__inner m-profile">
        ...
        <dl class="c-profile-list">
          ...
          <dt>趣味</dt>
          <dd>音楽鑑賞（韻シストとMariah Careyが好きです）、新しい知識の習得、キックボクシング、映画、アニメ（ガンダムならオリジンと鉄血のオルフェンズが好きです）</dd>
          <dt>好きな言葉</dt>
          <dd>「好きこそ物の上手なれ」</dd>
          <dd>「人事を尽くして天命を待つ」</dd>
          <dt>将来の夢</dt>
          <dd>猫がいる職場で猫に邪魔されながら仕事をすること</dd>
          <dd>プログラミングで人生を変えたいと思っている人の背中を押すこと</dd>
          <dd>従業員が自己実現をするためのチャンスとなるような会社を作ること</dd>
        </dl>
      </div>
    </section>
